...
var SecondLevel = (function (_super) {
    __extends(SecondLevel, _super);
    function SecondLevel(baba) {
        var _this = _super.call(this) || this;
        //陨石数组
        _this._bmArr = [];
        _this.timer = new egret.Timer(40, 0);
        _this.skinName = "secondLevelSkin";
        _this._baba = baba;
        return _this;
    }
    SecondLevel.prototype.partAdded = function (partName, instance) {
        _super.prototype.partAdded.call(this, partName, instance);
    };
    SecondLevel.prototype.childrenCreated = function () {
    ...
    SecondLevel.prototype.playAnimation = function (target, isLoop) {
        if (isLoop) {
    ...
    SecondLevel.prototype.Udatepage = function () {
    ...
    //碰撞检测
    SecondLevel.prototype.hitTest = function (obj1, obj2) {
...
__reflect(SecondLevel.prototype, "SecondLevel", ["eui.UIComponent", "egret.DisplayObject"]);
